...
export function ActionButton({
  ...
  const renderButton = (asTrigger = false) => {
    const buttonContent = (
      <>
    ...
    if (socialButton) {
      const config = socialConfig[socialButton.provider];
      return (
        <Button
          type={type}
    ...
    return (
      <Button
        ...
        onClick={asTrigger ? undefined : handleClick}
        {...props}
      >
        {buttonContent}
      </Button>
  ...
  if (alertDialog) {
    return (
      <AlertDialog open={isAlertOpen} onOpenChange={setIsAlertOpen}>
        <AlertDialogTrigger asChild>{renderButton(true)}</AlertDialogTrigger>
        <AlertDialogContent>
          <AlertDialogHeader>
